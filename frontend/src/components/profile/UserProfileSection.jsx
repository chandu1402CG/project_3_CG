      ...
      <ProfileCard>
        ...
        <CardContent sx={{ pt: 4 }}>
          {editMode ? (
            ...
            <>
              <Box sx={{ display: 'flex', flexDirection: { xs: 'column', md: 'row' }, gap: { xs: 4, md: 2 } }}>
                {/* Family Members Column */}
                <Box sx={{ flex: 1 }}>
                  <Typography variant="h6" color="primary" gutterBottom sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
